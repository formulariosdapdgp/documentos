...
def form_designacao_fcc():
    ...
    with st.form(key="fcc", clear_on_submit=True):
        ...
        with col_numero_ato:
            dados_fcc['numero_ato'] = st.text_input("Informe o número do ato:")
        with col_ano_ato:
            dados_fcc['ano_ato']= st.text_input("Informe o ano do ato:")
...
def gerar_form_designa_fcc(dados_designacao):
    with open("Ato_designação_fcc.html", "w", encoding='utf-8') as ato:
        ato.write('''<html lang="pt-br" >
            <head>
        ...
        ato.write(f'''
                        <p class="Texto_Justificado">Designa o Professor do Magist&eacute;rio Superior {nome_designado} para exercer a fun&ccedil;&atilde;o de&nbsp;Coordenador de&nbsp;P&oacute;s Gradua&ccedil;&atilde;o&nbsp;em Nanoci&ecirc;ncia e Nanobiotecnologia do IB&nbsp;(FCC).</p>
                        </td>
                    </tr>
                </tbody>
            </table>
            <p class="Texto_Justificado_Recuo_Primeira_Linha">A DECANA&nbsp;DE GEST&Atilde;O DE PESSOAS DA UNIVERSIDADE DE BRAS&Iacute;LIA, no uso de suas atribui&ccedil;&otilde;es legais, conferidas pelo Ato da Reitoria n&ordm; 72, publicado no DOU n. 13, de 20 de janeiro&nbsp;de 2021, se&ccedil;&atilde;o 2, p&aacute;gina 24, e de acordo com a compet&ecirc;ncia que lhe foi delegada por meio do Ato da Reitoria n. 304, de 23 de mar&ccedil;o de 2017, publicado no&nbsp;<em>DOU</em>&nbsp;
            ...
            <p class="Texto_Justificado_Recuo_Primeira_Linha">Designar, para mandato de 2 (dois) anos, o Professor do Magist&eacute;rio Superior {nome_designado}
              para exercer a fun&ccedil;&atilde;o de&nbsp;{"Coordenador" if dados_designacao['genero_coordenador'] == "Masculino" else "Coordenadora"} do&nbsp;
              {dados_designacao['nome_coordenacao']} {dados_designacao['descricao_funcao']} (FCC).</p>

            <p class="Texto_Justificado_Recuo_Primeira_Linha">&nbsp;</p>

            <p class="Texto_Justificado_Recuo_Primeira_Linha">&nbsp;</p>

            <p class="Tabela_Texto_Centralizado">Maria do Socorro Mendes Gomes&nbsp;</p>

            <p class="Tabela_Texto_Centralizado">&nbsp;Decana&nbsp;de Gest&atilde;o de Pessoas</p>
            </body>
            </html>''')
